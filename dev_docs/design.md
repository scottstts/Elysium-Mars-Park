...
4. **THE FOUNTAIN.** (2026-08-12 — replaced the Regolith Gardens, whose raked spirals and steel-edged beds never read at any honest viewing angle; see `systems/fountain.md`.) A monumental tiered fountain on a paved court between the plaza and the Residential Arc: a lobed basin with planted coping bays, a stepped island rising out of the water, four DUST DEVILS TURNED TO STONE carrying two gadrooned tazze (2026-08-12b — the caryatids were retired by decision: procedural anatomy never crosses the uncanny line, and the vortices monumentalise the planet's own weather at the one place the colony spends water in public), arcing jets and a crown, and the park's one recorded sound — the water itself, swelling as you approach. The basin water is a real-time heightfield simulation forced by the landing droplets. The excavation boulders stay, set as sculpture on the open regolith around it.
